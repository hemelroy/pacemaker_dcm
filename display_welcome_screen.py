...
#login_frame
panel2 = Label(login_frame, image = img)
panel2.place(x=0, y=0, relwidth=1, relheight=1, height=+30)

login_title_label = Label(login_frame, text="Login", fg = "red", bg="black", font = "Helvetica 16 bold italic", justify="center")
...
#username_field.grid(row=2, column=2, columnspan=8, sticky=N+S+E+W)
...
register_missingfield_label = Label(register_frame, text="Username or password is missing", font="Helvetica 12", justify="center")
register_existinguser_label = Label(register_frame, text="Username chosen already exists", font="Helvetica 12", justify="center")
...
lowRateInterval_label = Label(params_frame, text="Lower Rate Limit:", font = "Helvetica 12", justify="left")
...
uppRateInterval_label = Label(params_frame, text="Upper Rate Limit:", font = "Helvetica 12", justify="left")
...
vPaceAmp_label = Label(params_frame, text="Ventricular Amplitude:", font = "Helvetica 12", justify="left")
...
vPulseWidth_label = Label(params_frame, text="Ventricular Pulse Width:", font = "Helvetica 12", justify="left")
...
aPaceAmp_label = Label(params_frame, text="Atrial Amplitude:", font = "Helvetica 12", justify="left")
...
aPulseWidth_label = Label(params_frame, text="Atrial Pulse Width:", font = "Helvetica 12", justify="left")
